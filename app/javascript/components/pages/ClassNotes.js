...
const ClassNotes = ({ posts }) => {
    const classNotes = posts?.filter((post) => {
        return post.category_tag === "Class Notes"
    })
  return (
    <>
      <h2 className="mypost-heading">Class Notes</h2>
      <main className="mypost-cards">
        {classNotes?.map((post, index) =>{
